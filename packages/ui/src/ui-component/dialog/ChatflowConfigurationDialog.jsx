...
const CHATFLOW_CONFIGURATION_TABS = [
    {
        label: 'chatflowConfig.tabs.security',
        id: 'security'
    },
    {
        label: 'chatflowConfig.tabs.starterPrompts',
        id: 'conversationStarters'
    },
    {
        label: 'chatflowConfig.tabs.followUpPrompts',
        id: 'followUpPrompts'
    },
    {
        label: 'chatflowConfig.tabs.speechToText',
        id: 'speechToText'
    },
    {
        label: 'chatflowConfig.tabs.chatFeedback',
        id: 'chatFeedback'
    },
    {
        label: 'chatflowConfig.tabs.analyseChatflow',
        id: 'analyseChatflow'
    },
    {
        label: 'chatflowConfig.tabs.leads',
        id: 'leads'
    },
    {
        label: 'chatflowConfig.tabs.fileUpload',
        id: 'fileUpload'
    },
    {
        label: 'chatflowConfig.tabs.postProcessing',
        id: 'postProcessing',
    ...
    const component = show ? (
        ...
        >
            <DialogTitle sx={{ fontSize: '1.25rem' }} id='alert-dialog-title'>
                {dialogProps.title || t('chatflowConfig.title')}
            </DialogTitle>
            <DialogContent>
                <Tabs
                    sx={{
